...
Route::group(['prefix' => 'contact', 'as' => 'contact.', 'middleware' => ['auth']], function () {
    ...
    Route::put('/update/{id}', [App\Http\Controllers\Contact\ContactController::class, 'update'])->name('update');
    Route::delete('/delete/{id}', [App\Http\Controllers\Contact\ContactController::class, 'delete'])->name('delete');
